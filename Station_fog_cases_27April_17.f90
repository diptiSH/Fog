...
open(3,file="fog_matrix_all_4April_2017.txt")
...
write (filename, "(A50,I1,A4)") "/home/dipti/Documents/data/North_india_31Stations/",f,".txt"

else 

write (filename, "(A50,I2,A4)") "/home/dipti/Documents/data/North_india_31Stations/",f,".txt"
...
if(sum(fog_mat_int(:,i,mon,k)).gt.11)then
NR=NR+1
